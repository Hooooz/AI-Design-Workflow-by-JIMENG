...
# API配置
JIMENG_API_TOKEN = "881abd7d55218d875202db7510cdafbb" # 你登录即梦获得的session_id   
IMG_SAVA_FOLDER = "/Users/huangchuhao/Downloads/AI 工具/Cursor 代码库/Howie AI 工作室/彩友乐 AI 提效/AI设计工作流/test_workspace/image-gen-server/images" # 图片默认保存路径
